    ...
    <section className="relative py-8 md:py-16 px-4">
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="relative grid grid-cols-3 lg:grid-cols-5 gap-2 md:gap-6 lg:gap-16 mb-8 md:mb-16 lg:items-start overflow-visible">
          {/* Левая колонка - текст */}
          <div className="col-span-2 lg:col-span-3 bg-white/40 backdrop-blur-sm rounded-xl  rounded-xl md:rounded-2xl p-4 md:p-6 mb-0 md:mb-0">
        ...
        {/* Подход и философия */}
        <div className="mb-8 md:mb-12  bg-white/40 backdrop-blur-sm rounded-xl rounded-xl md:rounded-2xl p-4 md:p-6">
        ...
        <div className="grid grid-cols-1 bg-white/40 backdrop-blur-sm rounded-xl lg:grid-cols-2 gap-6 md:gap-12 mb-8 md:mb-12">
          {/* Левая колонка - текст */}
        ...
        <div className="grid grid-cols-1  lg:grid-cols-2 gap-6 md:gap-12 mb-8 md:mb-12">
          ...
          <div className=" md:rounded-2xl bg-white/40 backdrop-blur-sm rounded-xl p-4 md:p-6">
          ...
          <div className="bg-white/40 backdrop-blur-sm rounded-xl md:rounded-2xl p-4 md:p-6">
